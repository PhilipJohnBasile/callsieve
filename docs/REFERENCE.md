...
[Quick start](../README.md) · [Development](#development)

Detailed CLI commands, example output, integration notes, and evaluation workflows.
...
Optional embeddings, Git history signals, and editor integrations are available in the current tree. Their setup and coverage vary; see the integration guides above.
